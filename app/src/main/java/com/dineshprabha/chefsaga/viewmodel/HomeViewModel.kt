...
import com.dineshprabha.chefsaga.data.CategoryList
...
//    }
    ...
    fun observeCategroiesLiveData():LiveData<List<Category>>{
    ...
    fun observeSearchMealLiveData(): MutableLiveData<List<Meal>> {
